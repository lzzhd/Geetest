...
Location = function () {}
Location.prototype.href = "https://www.geetest.com/demo/slide-float.html";
Location.prototype.hostname = "www.geetest.com";
...
!function() {
    !function(t, e) {
        ...
        g = (h[$_CJDQ(288)],
        f[$_CJET(92)] + $_CJDQ(270)),
        ht = window[$_CJDQ(193)],
        w = (e = h[$_CJDQ(71)]($_CJET(27)),
...
function get_aa(e, c, s) {
    var b = {};
    b["$_HBA"] = e;
    b.__proto__ = lz.W_;
    return b["$_BBCA"](b["$_GEy"](), c, s)
}
// e 轨迹
// s 返回值
function get_w(e, s, gt, challenge, random, t1, t2) {
    var u = new lz.E_().encrypt(random);
    var userresponse = lz.H_(Number(t1), challenge);
    var rp = lz.U_(gt + challenge.slice(0, 32) + Number(t2));
    var aa = get_aa(JSON.parse(e), [12,58,98,36,43,95,62,15,12], s);
    ...
    console.log(dict)
    var t = lz.V_.encrypt(JSON.stringify(dict), random);
    return lz.m_["$_GFm"](t) + u
}
